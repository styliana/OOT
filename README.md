1) Vectors - how adapter, decorator and inheritance can be applied in vector calculations.
2) Currency Exchange App - console SOLID app converting currencies based on Polish National Bank data.
3) Infection Simulation - epidemic simulation app using Memento pattern and Vectors logic.

<img width="304" height="456" alt="image" src="https://github.com/user-attachments/assets/09e4fac6-c587-4975-87cc-9153b895f6cd" />
